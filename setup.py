...
plugin_identifier = "octopiwifi"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_octopiwifi"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-OctoPiWifi"
...
# module
plugin_description = """Plugin to manage NetworkManager on OctoPi 1.1.0+"""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-OctoPiWifi"
